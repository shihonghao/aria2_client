    ...
    items: [
      ...
      FormItem<String>(
        ...
        options: [
          ...
          FormItemOption(label: "FULL", value: "full"),
          FormItemOption(label: "HIDE", value: "hide"),
        ],
      ),
      ...
      FormItem<String>(
        ...
        key: 'file-allocation',
        options: [
          FormItemOption(label: "NONE", value: "none"),
          FormItemOption(label: "PREALLOC", value: "prealloc"),
          FormItemOption(label: "FALLOC", value: "falloc"),
