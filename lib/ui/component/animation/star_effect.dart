      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return GestureDetector(
            ...
            child: CustomPaint(
                size: _size,
                painter: StarPainter(
                    starFieldBackgroundColor: _setting.starFieldBackgroundColor,
                    starFov: _starFov,
                    center: _center,
...
class StarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // bgPaint.shader = ui.Gradient.linear(Offset.zero ,Offset(size.width,size.height), [
    //   const Color.fromRGBO(15, 23, 42, 1.00),
    //   const Color.fromRGBO(51, 65, 85, 1.00)
    // ]);
    canvas.drawRect(
