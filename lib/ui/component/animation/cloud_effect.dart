...
class _CloudEffect extends State<CloudEffect>
  ...
  Future<List<ui.Image>> loadImages() async {
    ...
    images.add(await loadImage("assets/img/cloud1.png"));
    images.add(await loadImage("assets/img/cloud2.png"));
    images.add(await loadImage("assets/img/cloud3.png"));
    images.add(await loadImage("assets/img/cloud4.png"));
    images.add(await loadImage("assets/img/cloud5.png"));
    return images;
  }
  ...
  void buildClouds(List<ui.Image> imageData) {
    ...
    for (var value in imageData) {
      ...
      clouds.add(Cloud(
          Offset(
              // -value.width * (1 + random.nextDouble() * 0.2),
...
class _CloudPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var cloud in clouds) {
      ...
      // canvas.drawCircle(cloud.position, 5, paint..color= Colors.black);
      // canvas.drawCircle(Offset(cloud.position.dx + cloud.image.width,cloud.position.dy + cloud.image.height), 5, paint..color= Colors.black);
      // canvas.drawCircle(Offset(800 / cloud.scale,cloud.position.dy),5, paint..color= Colors.black);
      canvas.restore();
    }
  }
